        ...
        <div class="row">
          <div class="col-lg-4">
            ...
            <div class="social-icons mt-3">
              <a href="https://www.instagram.com/tokencafeapp/" class="text-white-50 me-3 neon-icon-hover" title="Instagram" target="_blank" rel="noopener">
                <i class="fa-brands fa-instagram fs-4"></i>
              </a>
              <a href="https://twitter.com/tokencafeapp" class="text-white-50 me-3 neon-icon-hover" title="Twitter/X" target="_blank" rel="noopener">
                <i class="fa-brands fa-twitter fs-4"></i>
              </a>
              <a href="https://t.me/+O5b7SFmJX2UyYWQ5" class="text-white-50 me-3 neon-icon-hover" title="Telegram" target="_blank" rel="noopener">
                <i class="fa-brands fa-telegram fs-4"></i>
              </a>
              <a href="https://wa.me/5543999446606" class="text-white-50 me-3 neon-icon-hover" title="WhatsApp" target="_blank" rel="noopener">
...
<script src="assets/js/shared/sucessoeerro.js?v=<?= htmlspecialchars(defined('ASSET_VERSION') ? ASSET_VERSION : '9.9', ENT_QUOTES, 'UTF-8') ?>"></script>
...
<script>
  (function() {
    try {
      ...
      box.style.maxWidth = "min(760px, calc(100vw - 24px))";
      box.style.maxHeight = "min(320px, calc(100vh - 24px))";
      box.style.overflow = "auto";
      box.style.background = "rgba(0,0,0,0.90)";
      box.style.color = "#fff";
      box.style.border = "1px solid rgba(255,255,255,0.20)";
      box.style.borderRadius = "10px";
      box.style.padding = "10px 12px";
      box.style.font = "12px/1.35 ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace";
