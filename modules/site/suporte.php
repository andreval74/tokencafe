      ...
      <div class="row justify-content-center text-center">
        <div class="col-lg-10 text-center">
          <h1 class="display-4 fw-bold mb-2 text-white">
            Suporte <span class="gradient-text">TokenCafe</span>
          </h1>
    ...
    <div class="tc-black-panel py-2 mt-4">
      <div class="blockchain-slider">
        <div class="blockchain-track">
          <span class="blockchain-item d-inline-flex align-items-center gap-2 text-white-50"><i class="bi bi-chat-dots text-primary"></i><span>Dúvidas gerais</span></span>
          <span class="blockchain-item d-inline-flex align-items-center gap-2 text-white-50"><i class="bi bi-wrench text-primary"></i><span>Suporte técnico</span></span>
          <span class="blockchain-item d-inline-flex align-items-center gap-2 text-white-50"><i class="bi bi-link-45deg text-primary"></i><span>Integrações</span></span>
          <span class="blockchain-item d-inline-flex align-items-center gap-2 text-white-50"><i class="bi bi-bug text-primary"></i><span>Bug report</span></span>
          <span class="blockchain-item d-inline-flex align-items-center gap-2 text-white-50"><i class="bi bi-briefcase text-primary"></i><span>Comercial</span></span>
          <span class="blockchain-item d-inline-flex align-items-center gap-2 text-white-50"><i class="bi bi-whatsapp text-primary"></i><span>WhatsApp</span></span>
          <span class="blockchain-item d-inline-flex align-items-center gap-2 text-white-50"><i class="bi bi-envelope text-primary"></i><span>E-mail</span></span>
          <span class="blockchain-item d-inline-flex align-items-center gap-2 text-white-50"><i class="bi bi-shield-check text-primary"></i><span>Segurança</span></span>
