      ...
      <div class="row g-4 align-items-stretch">
        ...
        <div class="col-lg-5 text-center">
          <div class="feature-card h-100 p-4">
            <img src="assets/imgs/mundo.png" alt="Meta de Impacto" class="img-fluid rounded-3 tc-impact-card-img mb-3" loading="lazy">
            <h3 class="h2 fw-bold text-white mb-2">Meta de Impacto</h3>
  ...
  <section class="pb-5">
    <div class="container text-center">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <h3 class="h2 fw-bold text-white mb-2">Faça parte dessa transformação</h3>
          <p class="text-secondary mb-4">
            Se você representa uma empresa, instituição ou comunidade, entre em contato para apoiar e ampliar o impacto do programa.
          </p>
          <div class="d-flex flex-wrap gap-3 justify-content-center">
            <a href="https://wa.me/5543999446606?text=Ol%C3%A1!%20Quero%20fazer%20parte%20do%20TokenCafe%20Social%20e%20apoiar%20o%20ensino%20Web3." class="btn btn-primary btn-lg fw-bold" target="_blank" rel="noopener noreferrer">
