  <?php
    $pageTitle = "Criador de Contratos de Token - TokenCafe";
    $pageDescription = "Implante seu ERC-20 com segurança.";
    $pageKeywords = "token, ERC-20, contrato, deploy, Web3";
    $headerVariant = "module";
    $moduleHeaderTitle = "Criador de Contratos de Token";
    $moduleHeaderSubtitle = "Implante seu ERC-20 com segurança";
    $moduleHeaderIcon = "fa-add";
    $moduleHeaderIconAlt = "Token Creator";
  ?>
    ...
    <main class="py-3 mb-1">
      <div class="container-fluid">
        <div class="row justify-content-center">
                    ...
                    <div class="row g-4">
                      ...
                      <div class="col-12">
                        ...
                        <div class="input-group">
                          ...
                          <button class="btn btn-outline-secondary tc-action-copy" type="button" id="copy-owner-address-btn" title="Copiar">
          ...
          <button id="btn-clear-form" class="tc-btn-clear-ds px-4 py-2">
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-12">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <button class="btn btn-outline-info tc-action-copy" type="button" id="copy-contract-btn" title="Copiar">
                            <i class="bi bi-clipboard"></i>
                          </button>
                          <button class="btn btn-outline-primary" type="button" id="view-explorer-btn" title="Ver no Explorer">
                            <i class="bi bi-eye"></i>
                          </button>
                          <button class="btn btn-outline-warning" type="button" id="add-to-metamask-btn" title="Adicionar ao MetaMask"><img src="assets/imgs/metamask.svg" alt="MetaMask" width="32" height="32" /></button>
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <button class="btn btn-outline-info tc-action-copy" type="button" id="copy-hash-btn" title="Copiar">
                            <i class="bi bi-clipboard"></i>
                          </button>
                    ...
                    <div class="row mt-3" id="network-info-section">
                      <div class="col-12">
                        <div class="alert alert-info mb-0">
                          ...
                          <li>
                            <strong>Analisar Contrato:</strong>
                            Abre a página de análise e verificação da blockchain (BSCScan/EtherScan)
                          </li>
                          <br />
                          <strong>Para verificação manual no explorer:</strong>
                          <li>Clique em "Analisar Contrato" para ir ao site da blockchain</li>
        ...
        <div class="modal-content bg-dark text-white border-primary">
          ...
          <div class="modal-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
              ...
              <div class="btn-group">
                <button type="button" class="btn btn-outline-success btn-sm tc-action-copy" data-action="copy-modal-code">
  ...
  <div class="modal fade" id="contractPreviewModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
      <div class="modal-content bg-dark text-light border">
        ...
        <div class="modal-body">
          <div id="preview-token-info" class="mb-3 tc-note"></div>
          <pre id="preview-contract-code" class="code-display bg-black p-3 rounded tc-note border border-secondary"></pre>
        </div>
        <div class="modal-footer">
          <div class="btn-row">
            <button type="button" class="btn btn-outline-primary tc-action-copy" data-action="copy-contract-code">
  ...
  <div class="modal fade" id="verifyInfoModal" tabindex="-1" aria-hidden="true">
    ...
    <?php if (isset($enqueue_script_module)) { $enqueue_script_module("assets/js/modules/tokens/token_add.js"); } ?>
