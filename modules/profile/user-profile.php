        ...
        <div class="profile-info">
          ...
          <div class="profile-details">
            ...
            <div class="d-flex align-items-center justify-content-center gap-2 mb-3">
              <span id="profileAddress" class="tc-note font-monospace">0x1234...5678</span>
              <button class="tc-icon-btn-ds tc-action-copy" id="btnCopyAddress" type="button" title="Copiar endereço">
