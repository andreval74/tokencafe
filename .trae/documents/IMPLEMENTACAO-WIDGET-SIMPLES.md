...
<body class="bg-page-black">
    <!-- Header -->
    <div data-component="tools-header.html" data-icon="bi-rocket" data-title="Gerar Widget" data-subtitle="Crie seu widget de venda em 3 passos">
    </div>
                        ...
                        <form id="widgetForm">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="projectName" 
                                       placeholder="Ex: TokenCafe Coin" required>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="saleContract" 
                                           placeholder="0x1234..." required>
                                    ...
                                    <div id="advancedOptions" class="accordion-collapse collapse" 
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="mb-3 mt-3">
                                                ...
                                                <input type="text" class="form-control" id="buyButtonText" 
                                                       placeholder="Comprar Tokens" value="Comprar Tokens">
                                            </div>
                                        </div>
                                    </div>
                                </div>
