...
class RPCSimple {
    ...
    validateNetworkData(networkData) {
        ...
        return {
            ...
            blockExplorerUrls: blockExplorerUrls ? 
                (Array.isArray(blockExplorerUrls) ? blockExplorerUrls : [blockExplorerUrls]) : 
                undefined
        };
    }
    ...
    generateAddNetworkLink(networkData) {
        const params = new URLSearchParams({
            ...
            blockExplorerUrls: networkData.blockExplorerUrls ? 
                JSON.stringify(networkData.blockExplorerUrls) : ''
        });
    ...
    async processUrlParams() {
        ...
        if (urlParams.has('chainId')) {
            const networkData = {
                ...
                blockExplorerUrls: urlParams.get('blockExplorerUrls') ? 
                    JSON.parse(urlParams.get('blockExplorerUrls')) : undefined
            };
    ...
    async getRpcsFromRpcs(chainId) {
        try {
            ...
            return networkData.rpc.map((rpc, index) => {
    ...
    getDefaultNativeCurrency(chainId) {
        ...
        return defaultCurrencies[chainId] || { 
            name: 'Unknown', 
            symbol: 'UNKNOWN', 
            decimals: 18 
        };
    ...
    getHardcodedNetworkRpcs(chainId) {
        ...
        const rpcLists = {
            ...
            '0x1': [ // Ethereum Mainnet
                ...
                { url: 'https://eth-mainnet.alchemyapi.io/v2/', name: 'Alchemy', public: false },
                { url: 'https://cloudflare-eth.com', name: 'Cloudflare', public: true },
                { url: 'https://ethereum.publicnode.com', name: 'PublicNode', public: true },
                { url: 'https://mainnet.gateway.tenderly.co', name: 'Tenderly', public: true },
                { url: 'https://rpc.ankr.com/eth', name: 'Ankr', public: true }
            ],
            '0x89': [ // Polygon
                { url: 'https://polygon-rpc.com', name: 'Polygon Official', public: true },
                { url: 'https://rpc-mainnet.matic.network', name: 'Matic Network', public: true },
                { url: 'https://rpc.ankr.com/polygon', name: 'Ankr', public: true },
                { url: 'https://polygon.gateway.tenderly.co', name: 'Tenderly', public: true },
                { url: 'https://polygon-mainnet.public.blastapi.io', name: 'Blast API', public: true }
            ],
            '0x38': [ // BSC
                { url: 'https://bsc-dataseed.binance.org', name: 'Binance Official', public: true },
                { url: 'https://bsc-dataseed1.defibit.io', name: 'DeFiBit', public: true },
                { url: 'https://bsc-dataseed1.ninicoin.io', name: 'NiniCoin', public: true },
                { url: 'https://rpc.ankr.com/bsc', name: 'Ankr', public: true }
            ],
            '0xa4b1': [ // Arbitrum One
                { url: 'https://arb1.arbitrum.io/rpc', name: 'Arbitrum Official', public: true },
                { url: 'https://rpc.ankr.com/arbitrum', name: 'Ankr', public: true },
                { url: 'https://arbitrum.gateway.tenderly.co', name: 'Tenderly', public: true }
            ],
            '0xa86a': [ // Avalanche
                { url: 'https://api.avax.network/ext/bc/C/rpc', name: 'Avalanche Official', public: true },
                { url: 'https://rpc.ankr.com/avalanche', name: 'Ankr', public: true },
                { url: 'https://avalanche.gateway.tenderly.co', name: 'Tenderly', public: true }
            ],
            // Testnets
            '0xaa36a7': [ // Sepolia Testnet
                { url: 'https://sepolia.infura.io/v3/', name: 'Infura', public: false },
                { url: 'https://eth-sepolia.public.blastapi.io', name: 'Blast API', public: true },
                { url: 'https://rpc.sepolia.org', name: 'Sepolia.org', public: true },
                { url: 'https://rpc2.sepolia.org', name: 'Sepolia.org 2', public: true },
                { url: 'https://rpc.ankr.com/eth_sepolia', name: 'Ankr', public: true }
            ],
            '0x5': [ // Goerli Testnet
                { url: 'https://goerli.infura.io/v3/', name: 'Infura', public: false },
                { url: 'https://eth-goerli.alchemyapi.io/v2/', name: 'Alchemy', public: false },
                { url: 'https://goerli.gateway.tenderly.co', name: 'Tenderly', public: true },
                { url: 'https://rpc.ankr.com/eth_goerli', name: 'Ankr', public: true }
            ],
            '0x13881': [ // Polygon Mumbai
                { url: 'https://rpc-mumbai.maticvigil.com', name: 'Matic Vigil', public: true },
                { url: 'https://matic-mumbai.chainstacklabs.com', name: 'ChainStack', public: true },
                { url: 'https://rpc.ankr.com/polygon_mumbai', name: 'Ankr', public: true },
                { url: 'https://polygon-mumbai.gateway.tenderly.co', name: 'Tenderly', public: true }
            ],
            '0x61': [ // BSC Testnet
                { url: 'https://data-seed-prebsc-1-s1.binance.org:8545', name: 'Binance Official', public: true },
                { url: 'https://data-seed-prebsc-2-s1.binance.org:8545', name: 'Binance 2', public: true },
                { url: 'https://bsc-testnet.public.blastapi.io', name: 'Blast API', public: true }
            ],
            '0x66eed': [ // Arbitrum Goerli
                { url: 'https://goerli-rollup.arbitrum.io/rpc', name: 'Arbitrum Official', public: true },
                { url: 'https://arbitrum-goerli.gateway.tenderly.co', name: 'Tenderly', public: true }
            ],
            '0xa869': [ // Avalanche Fuji
                { url: 'https://api.avax-test.network/ext/bc/C/rpc', name: 'Avalanche Official', public: true },
                { url: 'https://rpc.ankr.com/avalanche_fuji', name: 'Ankr', public: true }
            ]
        };
