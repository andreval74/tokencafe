...
class BlockchainCore {
    ...
    filterNetworks(networks, criteria = {}) {
        return networks.filter(network => {
            ...
            if (criteria.symbol && network.nativeCurrency && 
                !network.nativeCurrency.symbol.toLowerCase().includes(criteria.symbol.toLowerCase())) {
                return false;
            }
    ...
    getErrorInfo(errorCode) {
        const errors = {
            4001: { message: 'Usuario rejeitou a solicitacao', type: 'user_rejection' },
            4100: { message: 'Metodo nao autorizado', type: 'unauthorized' },
            4200: { message: 'Metodo nao suportado', type: 'unsupported' },
            4900: { message: 'Desconectado de todas as chains', type: 'disconnected' },
            4901: { message: 'Nao conectado a chain solicitada', type: 'chain_disconnected' },
