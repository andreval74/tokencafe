...
try {
  ...
  const requiredDeps = ["express", "cors", "express-rate-limit", "solc", "helmet", "dotenv", "compression", "winston"];
...
if (fs.existsSync(".env")) {
  ...
  const requiredEnvs = ["NODE_ENV", "PORT", "SOLC_VERSION", "OPTIMIZATION_RUNS", "RATE_LIMIT_WINDOW", "RATE_LIMIT_MAX_REQUESTS"];
  ...
  // Verificar RPCs
  console.log("\n🌐 RPCs BLOCKCHAIN:");
  const rpcs = ["BSC_MAINNET_RPC", "BSC_TESTNET_RPC"];
