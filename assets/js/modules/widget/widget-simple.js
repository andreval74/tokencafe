 ...
 * Ao inicializar, valida automaticamente o contrato se o campo já tiver valor (ex: via URL params).
 */
...
class WidgetSimple {
  ...
  async init() {
    ...
    try {
      ...
      // Auto-validar se o campo de contrato já tiver valor (ex: URL params ou estado salvo)
      try {
        ...
        console.warn("Falha ao auto-validar contrato:", autoErr);
      }
            ...
            <div class="tc-widget tc-theme-light">
                ...
                <div class="tc-card">
                    <div class="tc-card-header">
                        ...
                        <span class="tc-badge-demo">DEMO</span>
                    </div>
                    ...
                    <div class="tc-debug d-none mt-3" id="purchaseDebug">
                        ...
                        <div class="tc-debug-content font-monospace tc-text-sm code-display max-height-240 overflow-auto border rounded p-2" id="purchaseDebugContent"></div>
                    </div>
  ...
  async updatePurchaseStatusBadge(config, address) {
    try {
      ...
      if (balance) {
        ...
        statusEl.innerHTML = `<div class="tc-badge-info">Carteira já possui ${balanceFmt} ${config.ui.tokenSymbol || "tokens"}</div>`;
      }
      if (balance && cap && balance.gte && balance.gte(cap)) {
        statusEl.innerHTML += `<div class="tc-badge-warning">Limite por carteira atingido</div>`;
      }
    } catch (_) {}
  }
}
