  ...
  function validateForm() {
    ...
    if (statusEl) {
      if (sVald) {
        ...
        statusEl.innerHTML = '<i class="bi bi-info-circle me-1" style="color:#60a5fa"></i>Preencha todos os campos obrigatórios para enviar.';
        statusEl.className = "small mt-3 text-secondary";
        statusEl.classList.remove("d-none");
      }
    }
