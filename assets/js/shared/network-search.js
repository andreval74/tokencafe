      ...
      <div class="autocomplete-item list-group-item list-group-item-action" data-chainid="${net.chainId}">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            ...
            <span class="d-block text-muted tc-text-sm">Chain ID: ${net.chainId}</span>
          </div>
          <span class="text-tokencafe tc-text-sm fw-bold">${net.nativeCurrency?.symbol || "N/A"}</span>
        </div>
      </div>
    `,
      )
...
function findContainers() {
  const nodes = document.querySelectorAll('[data-component*="network-search.php"]');
