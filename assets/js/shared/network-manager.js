...
export class NetworkManager {
  ...
  async loadFromLocalRpcs() {
    const paths = [
      "/data/rpcs.json", // Padrão servidor web (root relative)
      "data/rpcs.json", // Relativo simples
      "../data/rpcs.json", // 1 nível acima
      "../../data/rpcs.json", // 2 níveis acima
      "../../../data/rpcs.json", // 3 níveis acima
      "./data/rpcs.json" // Explicitamente corrente
    ];
